// NOTE: some parts of this database are in english, but it's only for organizational purposes.
// the bot will not have any english, thus it still abides by the rules of the community. hope that's okay!
...
app.post('/post', uploadProcessor.single('image'), (req, res)=>{
  ...
  let postToBeAddedToDB = {
    ...
    location: req.body.relativeLocation,
    refereceObject: req.body.refereceObject,
  }
